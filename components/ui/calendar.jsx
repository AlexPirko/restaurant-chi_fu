        ...
        <DayPicker
            ...
            classNames={{
                ...
                nav_button: cn(
                    ...
                    'h-7 w-7 bg-primary text-white p-0 hover:opacity-90',
                ),
                ...
                day_selected:
                    'bg-secondary text-white hover:bg-secondary/90 hover:text-white focus:bg-secondary focus:text-slate-50 dark:bg-slate-50 dark:text-slate-900 dark:hover:bg-slate-50 dark:hover:text-slate-900 dark:focus:bg-slate-50 dark:focus:text-slate-900',
